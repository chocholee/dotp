...
public class BlockDirective extends Directive {
    ...
    public boolean render(InternalContextAdapter context,
        ...
        if (overrideNode == null) {
            ...
            OverrideNodeWrapper.setParentForTop(new OverrideNodeWrapper(topNode), overrideNode);
    ...
    private OverrideNodeWrapper getOverrideNode(InternalContextAdapter context, String name) {
        return (OverrideNodeWrapper) context.get(OverrideNodeWrapper.getOverrideVariableName(name));
    }
